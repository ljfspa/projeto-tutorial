...
public class FuncionarioResourceIntTest {
    ...
    private static final Funcao DEFAULT_TIPO = Funcao.GERENTE;
    private static final Funcao UPDATED_TIPO = Funcao.ADMINISTRADOR;
    ...
    public void createFuncionario() throws Exception {
        ...
        assertThat(testFuncionario.getMatricula()).isEqualTo(DEFAULT_MATRICULA);
        assertThat(testFuncionario.getTipo()).isEqualTo(DEFAULT_TIPO);
    }
    ...
    public void updateFuncionario() throws Exception {
        ...
        Funcionario testFuncionario = funcionarioList.get(funcionarioList.size() - 1);
        assertThat(testFuncionario.getMatricula()).isEqualTo(UPDATED_MATRICULA);
        assertThat(testFuncionario.getTipo()).isEqualTo(UPDATED_TIPO);
    }
