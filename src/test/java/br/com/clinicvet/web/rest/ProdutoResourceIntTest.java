...
public class ProdutoResourceIntTest {
    ...
    private static final Long DEFAULT_QT_ESTOQUE = 1L;
    private static final Long UPDATED_QT_ESTOQUE = 2L;
    ...
    private static final Long DEFAULT_PRECO_COMPRA = 1L;
    private static final Long UPDATED_PRECO_COMPRA = 2L;

    private static final Long DEFAULT_PRECO_VENDA = 1L;
    private static final Long UPDATED_PRECO_VENDA = 2L;
    ...
    public void createProduto() throws Exception {
        ...
        assertThat(testProduto.getQtEstoque()).isEqualTo(DEFAULT_QT_ESTOQUE);
    ...
    public void getAllProdutos() throws Exception {
        ...
        restProdutoMockMvc.perform(get("/api/produtos?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].qtEstoque").value(hasItem(DEFAULT_QT_ESTOQUE.intValue())))
    ...
    public void getProduto() throws Exception {
        ...
        restProdutoMockMvc.perform(get("/api/produtos/{id}", produto.getId()))
            ...
            .andExpect(jsonPath("$.qtEstoque").value(DEFAULT_QT_ESTOQUE.intValue()))
    ...
    public void updateProduto() throws Exception {
        ...
        assertThat(testProduto.getQtEstoque()).isEqualTo(UPDATED_QT_ESTOQUE);
